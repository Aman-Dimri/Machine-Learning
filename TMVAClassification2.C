...
int TMVAClassification2( TString myMethodList = "" )
{
...
*/
   ...
   TString outfileName( "TMVA_Kstar.root" );
 ...
 //  dataloader->AddVariable( "daughter1_par_id := daughter1_par_id",'I' );
   dataloader->AddVariable( "pdaughter_px := pdaughter_px",'F' );
   dataloader->AddVariable( "pdaughter_py := pdaughter_py",'F' );
   dataloader->AddVariable( "pdaughter_pz := pdaughter_px",'F' );
   
   dataloader->AddVariable( "daughter1_px := daughter1_px",'F' );
   dataloader->AddVariable( "daughter1_py := daughter1_py",'F' );
   dataloader->AddVariable( "daughter1_pz := daughter1_px",'F' );
   //   factory->AddVariable( "daughter1_m := daughter1_px",'m' );
   //dataloader->AddVariable( "daughter2_par_id := daughter2_par_id",'I' );
   dataloader->AddVariable( "daughter2_px := daughter2_px",'F' );
   dataloader->AddVariable( "daughter2_py := daughter2_py",'F' );
   dataloader->AddVariable( "daughter2_pz := daughter2_pz",'F' );
   // You can add so-called "Spectator variables", which are not used in the MVA training,
   // but will appear in the final "TestTree" produced by TMVA. This TestTree will contain the
   // input variables, the response values of all trained MVAs, and the spectator variables

   dataloader->AddSpectator( "m := m", 'F' );
...
int main( int argc, char** argv )
{
   ...
   return TMVAClassification2(methodList);
}
